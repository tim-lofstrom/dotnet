...
namespace Bernt
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            camera.Position = new Vector3(0.0f, 50.0f, 1000.0f);
        ...
        protected override void LoadContent()
        {
            ...
            cube.Model = Content.Load<Model>("Models/bernt");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            cube.Rotation += (float)gameTime.ElapsedGameTime.TotalMilliseconds * MathHelper.ToRadians(0.1f);
            ...
            foreach (ModelMesh mesh in cube.Model.Meshes)
            {
                ...
                foreach (BasicEffect effect in mesh.Effects)
                {
                    ...
                    effect.World = transforms[mesh.ParentBone.Index] *
                        Matrix.CreateRotationY(cube.Rotation)
